...
export class APIservicesService {
  ...
  addInventory(addInventoryRequest: Inventory){
    ...
    addInventoryRequest, {observe:'response', responseType:'blob'});
  }
  ...
  getAllSendId(id: string): Observable<Notice[]>{
    return this.http.get<Notice[]>(this.baseApiUrl+ 'api/Notices/GetAllSendId/'+id)
  }

  getAllReceiveId(id: string): Observable<Notice[]>{
    return this.http.get<Notice[]>(this.baseApiUrl+ 'api/Notices/GetAllReceiveId/'+id)
  }

...
@Component({
  selector: 'app-listcancelmerchant',
  templateUrl: './listcancelmerchant.component.html',
  styleUrls: ['./listcancelmerchant.component.scss'],
  providers: [
    {
...
export class ListCancelMerchantComponent implements OnInit {

...
export class SearchFarmComponent implements OnInit {
  ...
  view(id: string) {
    const dialogRef = this.dialog.open(popUpSearchFarm, {
      width: 'auto',
      height: 'auto',
...
@Component({
  selector: 'popUpSearchFarm',
  templateUrl: 'popUpSearch.html',
  styleUrls: ['./popUpSearch.scss']
})
export class popUpSearchFarm implements OnInit {
  constructor(
  ...
  buyFruit(h: string) {
    const dialogRef = this.dialog.open(popUpBuy, {
      width: '700px',
      height: 'auto',
...
export class popUpBuy implements OnInit {
  constructor(
    public dialogRef: MatDialogRef<popUpBuy>,

...
@Component({
  selector: 'app-listwaitstore',
  templateUrl: './listwaitstore.component.html',
  styleUrls: ['./listwaitstore.component.scss'],
  providers: [
    {
...
export class ListWaitStoreComponent implements OnInit {

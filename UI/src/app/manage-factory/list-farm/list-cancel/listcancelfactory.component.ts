...
@Component({
  selector: 'app-listcancelfactory',
  templateUrl: './listcancelfactory.component.html',
  styleUrls: ['./listcancelfactory.component.scss'],
  providers: [
    {
...
export class ListCancelFactoryComponent implements OnInit {
  ...
  constructor(private testService: APIservicesService, private route: ActivatedRoute,

...
@Component({
  selector: 'app-listwaitfactory',
  templateUrl: './listwaitfactory.component.html',
  styleUrls: ['./listwaitfactory.component.scss'],
  providers: [
    {
...
export class ListWaitFactoryComponent implements OnInit {
